...
public final class AESCrypt {
    ...
    public static final byte[] ivBytes = {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,0x0,0x0, 0x0, 0x0,0x0, 0x0, 0x0, 0x0 };
     ...
     * SecretKeySpec is not relative to password
     */
    public static SecretKeySpec generateKey(final String password) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        // byte[] key = digest.digest(); //key come from password 
        //��key���յ�key
